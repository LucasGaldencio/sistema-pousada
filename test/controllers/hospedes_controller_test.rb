...
class HospedesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospede" do
    assert_difference("Hospede.count") do
      post hospedes_url, params: { hospede: { cpf: @hospede.cpf, data_nascimento: @hospede.data_nascimento, email: @hospede.email, nome: @hospede.nome, telefone: @hospede.telefone } }
    end
  ...
  test "should update hospede" do
    patch hospede_url(@hospede), params: { hospede: { cpf: @hospede.cpf, data_nascimento: @hospede.data_nascimento, email: @hospede.email, nome: @hospede.nome, telefone: @hospede.telefone } }
