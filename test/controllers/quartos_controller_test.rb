...
class QuartosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quarto" do
    assert_difference("Quarto.count") do
      post quartos_url, params: { quarto: { numero: @quarto.numero, preco: @quarto.preco, status: @quarto.status, tipo: @quarto.tipo } }
    end
  ...
  test "should update quarto" do
    patch quarto_url(@quarto), params: { quarto: { numero: @quarto.numero, preco: @quarto.preco, status: @quarto.status, tipo: @quarto.tipo } }
